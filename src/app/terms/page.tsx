    ...
    <div className="flex flex-col flex-1 bg-bg-canvas pb-12">
      ...
      <main className="px-4 py-6 space-y-8 text-sm text-text-primary leading-relaxed">
        ...
        <Section title="제9조 (유료서비스 이용)">
          ...
          <Notice>
            가격은 사전 공지 후 변경될 수 있습니다. 자동 갱신은 제공되지 않으며, 원하시는 경우 만료 후 수동으로 재구매하실 수 있습니다.
          </Notice>
        ...
        <Section title="제10조 (청약철회 및 환불)">
          <ol className="list-decimal pl-5 space-y-2.5 text-text-secondary">
            <li>
              <strong className="text-text-primary">청약철회 가능 기간</strong>: 구매일로부터 <strong className="text-text-primary">7일 이내</strong>에 청약철회를 요청할 수 있습니다.
          ...
          <Notice>
            디지털 콘텐츠(스캔 서비스)의 특성상 서비스 이용 시작 후에는 청약철회가 제한될 수 있습니다.
            구매 전 서비스 내용을 충분히 확인하시기 바랍니다.
          </Notice>
        </Section>
        ...
        <Section title="제11조 (AI 분석 결과의 한계 및 의료정보 면책)">
          ...
          <ol className="list-decimal pl-5 space-y-2.5 text-text-secondary mt-3">
            ...
            <li>분석 결과는 식품의약품안전처 공공데이터 및 AI 모델을 기반으로 제공되나, <strong className="text-text-primary">정확성을 100% 보장하지 않습니다</strong>. 성분 정보의 누락·오류·변경 가능성이 있습니다.</li>
        ...
        <Section title="제12조 (저작권 및 지식재산권)">
          <ol className="list-decimal pl-5 space-y-2 text-text-secondary">
            <li>서비스 내 제공되는 콘텐츠(AI 분석 결과 형식, UI 디자인, 텍스트, 아이콘 등)의 저작권 및 지식재산권은 회사에 귀속됩니다.</li>
            <li>이용자가 서비스 내에 업로드한 이미지는 서비스 제공 및 품질 개선 목적으로만 활용되며, 이용자의 동의 없이 제3자에게 제공되지 않습니다.</li>
            <li>서비스 내 공공데이터(식품의약품안전처 식품영양성분DB 등)는 해당 출처의 이용 조건에 따라 제공됩니다.</li>
            <li>이용자는 회사의 사전 동의 없이 서비스 내 콘텐츠를 복제·배포·전송·전시·판매하거나 상업적 목적으로 이용할 수 없습니다.</li>
          </ol>
        </Section>

        <Section title="제13조 (면책조항)">
          <ol className="list-decimal pl-5 space-y-2 text-text-secondary">
            <li>회사는 다음의 경우 서비스 제공 의무를 면합니다.
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>천재지변, 전쟁, 테러 등 불가항력적 사유</li>
                <li>이용자의 귀책 사유로 발생한 서비스 이용 장애</li>
                <li>Google, Toss Payments 등 제3자 서비스의 장애로 인한 서비스 중단</li>
              </ul>
            </li>
            <li>회사는 이용자가 서비스를 통해 얻은 정보의 신뢰성, 정확성, 완전성에 대해 회사의 고의 또는 중대한 과실이 없는 한 책임을 지지 않습니다.</li>
            <li>회사는 이용자가 서비스 내에서 또는 서비스를 통해 발생한 이용자 간의 분쟁에 개입하지 않으며, 이로 인한 손해에 대해 책임을 지지 않습니다.</li>
            <li>이용자의 임신 주차 오기입, 성분 알레르기 미기재 등 이용자 부주의로 인한 결과에 대해 회사는 책임을 지지 않습니다.</li>
          </ol>
        </Section>

        <Section title="제14조 (분쟁 해결 및 준거법)">
          <ol className="list-decimal pl-5 space-y-2 text-text-secondary">
            <li>서비스 이용과 관련하여 분쟁이 발생한 경우, 회사와 이용자는 상호 협의를 통해 해결하도록 노력합니다.</li>
            <li>협의가 이루어지지 않는 경우, 소비자기본법에 따른 소비자분쟁조정위원회에 조정을 신청하거나, 민사소송법상 관할법원에 소를 제기할 수 있습니다.</li>
            <li>본 약관 및 서비스 이용에 관한 분쟁에는 <strong className="text-text-primary">대한민국 법률</strong>이 적용됩니다.</li>
          </ol>
        </Section>

        <Section title="제15조 (관할법원)">
          <p className="text-text-secondary">
            본 약관과 관련된 소송의 관할법원은 <strong className="text-text-primary">서울중앙지방법원</strong>을 제1심 관할법원으로 합니다.
            단, 민사소송법에 따라 이용자의 주소지 관할 법원에 소를 제기할 수도 있습니다.
          </p>
        </Section>
        ...
        <div className="pt-2 pb-4 text-center text-xs text-text-tertiary">
          <p>부칙: 본 약관은 {EFFECTIVE_DATE}부터 시행합니다.</p>
          <p className="mt-1">
            개인정보 처리에 관한 사항은{' '}
            <a href="/privacy" className="underline underline-offset-2 text-text-secondary hover:text-text-primary transition-colors">
              개인정보처리방침
            </a>
            을 참고하시기 바랍니다.
          </p>
