...
export function BottomNav() {
  ...
  const navItems = [
    ...
    { icon: User, label: "내정보", path: "/settings" },
  ]

  return (
    <nav className="fixed bottom-0 w-full max-w-md left-1/2 -translate-x-1/2 z-50 border-t border-border-subtle bg-bg-surface pb-safe">
